...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="/assets/Quidmye/css/AdminLTE.css">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="/assets/Quidmye/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/assets/Quidmye/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/assets/Quidmye/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
      ...
      var formELement = this;
        ...
        $(this).ajaxSubmit({  // pre-submit callback
            ...
            error:         function(xhr, textStatus, errorThrown)  {
              formELement.parent().prepend("<div class=\"callout callout-danger\">" + xhr.responseJSON.errors.join("<br />") + "</div>");
            }
        });
